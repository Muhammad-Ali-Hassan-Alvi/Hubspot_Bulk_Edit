...
/**
 * HubSpot states for content pages
 * Official HubSpot states from documentation
 */
export const HUBSPOT_STATES = [
  // Draft states
  'DRAFT',
  'DRAFT_AB',
  'DRAFT_AB_VARIANT',
...
/**
 * Boolean options for HubSpot fields
 */
export const HUBSPOT_BOOLEAN_OPTIONS = ['true', 'false'] as const
