...
export default function Page() {
  ...
  const test = async () => {
    try {
      ...
      console.error('Caught in test():', err)

      // Optional: re-throw if you want to crash the app
      // throw err
    }
  }
    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a target="_blank" href="https://smuves-f3.sentry.io/issues/?project=4509728454082560">
            Issues Page
          </a>
